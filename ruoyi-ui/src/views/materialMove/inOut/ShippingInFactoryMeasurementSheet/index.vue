<template>
    ...
    <div class="app-container">
        <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" label-width="60px">
            <el-form-item label="日期:" prop="time" style="margin-left: -15px;">
        ...
        <el-table v-loading="loading" :data="dataList" border @selection-change="handleSelectionChange"
            ...
            <el-table-column fixed="left" label="单据编号" align="center" key="consume" prop="consume" />
            ...
            <el-table-column label="船名" align="center" sortable key="shipName" prop="shipName"
                :show-overflow-tooltip="true" />
            <el-table-column label="提单总量" align="center" sortable key="inspection" prop="inspection" width="100"
                :show-overflow-tooltip="true" />
            <el-table-column label="商检总量" align="center" sortable key="propose" prop="propose" width="100" />
        ...
        <el-dialog :title="title" :visible.sync="open" width="1200px" append-to-body>
            <el-form ref="formDialog" :model="form" :rules="rules" label-width="120px">
                ...
                <el-row>
                    <el-col :span="6">
                        <el-form-item label="发货港:" prop="inoutName">
                            <el-input v-model="form.inoutName" size="mini" style="width: 150px;" type="number"
                    ...
                    <el-col :span="6">
                        <el-form-item label="内外贸:" prop="Amnt">
                            <el-select :value="form.Dim" value-key="label" style="width: 150px;" @change="form.Dim = $event"
                                placeholder="内外贸" clearable size="mini">
                                <el-option v-for="dict in DomesticForeignTrade" :key="dict.value" :label="dict.label"
                                    :value="dict" />
                            </el-select>
                        </el-form-item>
                    </el-col>
                ...
                <el-row>
                    <el-col :span="6">
                        <el-form-item label="录入者:" prop="createUser">
                            <el-input size="mini" disabled v-model="form.createUser" style="width: 150px;" placeholder="录入者"
                                maxlength="30" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="录入时间:" prop="createTime">
                            <el-date-picker v-model="form.createTime" disabled size="mini" style="width: 150px;"
                                type="datetime" placeholder="录入时间">
                            </el-date-picker>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="关闭者:" prop="closeUser">
                            <el-input size="mini" disabled v-model="form.closeUser" style="width: 150px;" placeholder="关闭者"
                                maxlength="30" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="关闭日期:" disabled prop="closeTime">
                ...
                <el-row>
                    <el-col :span="6">
                        <el-form-item label="单据编号:" prop="code">
                            <el-input size="mini" disabled v-model="form.code" style="width: 150px;" placeholder="单据编号"
                                maxlength="30" />
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="备注:" prop="remark">
                            <el-input size="mini" v-model="form.remark" type="textarea" placeholder="单据编号" maxlength="30" />
                        </el-form-item>
                    </el-col>
                </el-row>
                <el-row>
                    ...
                    <el-col :span="3">
                        <el-form-item label="">
                            <el-button type="" plain size="mini" @click="handleShare">分摊</el-button>
                        </el-form-item>
                    </el-col>
                    <el-col :span="3">
                        <el-form-item label="">
...
<script>
export default {
    name: "ShippingInFactoryMeasurementSheet",
    components: {},
    data() {
        return {
            DomesticForeignTrade: [
                {
                    label: "内贸",
                    value: "0"
                }, {
    ...
    methods: {
        ...
        handleDelete(row) {
            ...
            this.$modal.confirm('是否确认删除"' + userIds + '"的数据项？').then(() => {
                return this.$api.i_shipIntDelete({ id: userIds })
            }).then(() => {
                this.getList();
        ...
        handleClose(row) {
            ...
            this.$modal.confirm('是否确认关闭"' + userIds + '"的数据项？').then(() => {
                return this.$api.i_shipIntClose({ id: userIds })
            }).then(() => {
                this.getList();
        ...
        selectOption(option) {
            if (option == "Option1") {
                this.$message.success("只计算主计量单")
            } else {
                this.$message.success("通过罐计量计算")
            }
