    ...
    <div class="app-container">
        <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" label-width="80px">
            ...
            <el-form-item label="请购单号:" prop="num">
                <el-input type="text" v-model="queryParams.num" maxlength="20" placeholder="请购单号" clearable></el-input>
            </el-form-item>
            <el-form-item>
        ...
        <el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="请购单号" align="center" key="num" prop="num" :show-overflow-tooltip="true">
            ...
            <el-table-column label="审核状态" align="center" key="status" prop="status" :show-overflow-tooltip="true">
                <template slot-scope="scope">
                    {{ scope.row.status == 0 ? '未提交' : scope.row.status == 1 ? '未审核' : scope.row.status == 2 ? "已撤回" :
                        scope.row.status == 3 ? "审核通过" : scope.row.status == 4 ? "驳回" : "" }}
                </template>
            </el-table-column>
            <el-table-column label="请购时间" align="center" key="Purchasetime" prop="Purchasetime"
                :show-overflow-tooltip="true" />
            <el-table-column label="计划使用时间" align="center" key="Plannedtime" prop="Plannedtime"
                :show-overflow-tooltip="true" />
            <el-table-column label="实际入库时间" align="center" key="Actualtime" prop="Actualtime"
                :show-overflow-tooltip="true" />
            <el-table-column label="请购部门" align="center" key="department" prop="department" :show-overflow-tooltip="true">
            </el-table-column>
            <el-table-column label="请购人" align="center" key="user" prop="user" :show-overflow-tooltip="true" />
            <el-table-column label="审核人" align="center" key="auditor" prop="auditor" :show-overflow-tooltip="true" />
...
export default {
    ...
    methods: {
        ...
        /** 新增按钮操作 */
        handleAdd() {
            this.$router.push("/equipment/submitAdd");
        },
        //修改
        handleUpdate() {
