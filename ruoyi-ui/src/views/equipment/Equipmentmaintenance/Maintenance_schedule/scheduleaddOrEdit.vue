  ...
  <div>
    ...
    <el-card class="box-card">
      ...
      <el-form ref="formForm" :model="formForm" label-width="120px" :rules="rulesForm">
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="维护计划名称:" prop="name">
              <el-input style="width: 90%" v-model="formForm.name" placeholder="维护计划名称" type="text"
                        maxlength="30"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="维护计划编码:" prop="num">
              <el-input style="width: 90%" v-model="formForm.num" placeholder="维护计划编码"
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="执行规则:" prop="Executiverule">
              <el-select style="width: 90%" v-model="formForm.Executiverule" placeholder="执行规则" clearable>
                <el-option v-for="dict in RequisitionDepartment" :key="dict.value" :label="dict.label"
                           :value="dict.value"/>
              </el-select>
            </el-form-item>
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="维护负责人:" prop="supervisor">
              <el-select style="width: 90%" v-model="formForm.supervisor" placeholder="维护负责人" clearable>
                <el-option v-for="dict in RequisitionDepartment" :key="dict.value" :label="dict.label"
                           :value="dict.value"/>
              </el-select>
            </el-form-item>
        ...
        <el-row :gutter="20">
          <el-col :span="20">
            <el-form-item label="维护内容:" prop="remack">
              <el-input style="width: 90%" v-model="formForm.remack" placeholder="维护内容"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
    ...
    <el-card class="box-card">
      ...
      <el-row :gutter="20">
        <el-col :span="1.5">
          ...
          <el-col :span="1.5">
            <el-button type="danger" plain @click="handleRemove" :disabled="single">移除</el-button>
          </el-col>
        </el-col>
      </el-row>
    ...
    <el-card class="box-card " style="margin-bottom: 100px">
      ...
      <el-row :gutter="20">
        <el-col :span="1.5">
          <el-col :span="1.5">
            <el-button type="success" plain @click="handleImport">上传文档</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button type="danger" plain @click="handleRemoveTable" >移除</el-button>
          </el-col>
        </el-col>
      </el-row>
      <el-table :data="form.files" @selection-change="handleSelectionTable">
        <el-table-column fixed="left" type="selection" width="50" align="center"/>
    ...
    <el-dialog :title="openTitle" :visible.sync="openTable" width="60%" append-to-body>
      <el-form :model="queryParamsTable" ref="queryForm" size="small" :inline="true" label-width="130px"
        ...
        <el-form-item label="设备名称:" prop="status">
          <el-input type="text" v-model="queryParamsTable.name" maxlength="20" placeholder="设备名称"
                    clearable></el-input>
        </el-form-item>
        <el-form-item label="设备编码:" prop="num">
          <el-input type="text" v-model="queryParamsTable.num" maxlength="20" placeholder="设备编码"
                    clearable></el-input>
        </el-form-item>
        <el-form-item>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="submitFileTable">确 定</el-button>
        <el-button @click="openTable = false">取 消</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      formForm: {
        ...
        claimpersonemail: "",
        claimpersonaddress: "",
        claimpersondepartment: "",
        claimpersonposition: "",
        claimpersonpositionphone: "",
        claimpersonpositionemail: "",
        claimpersonpositionaddress: "",
        useFlag: "1"
      },
  ...
  methods: {
    ...
    handleRemove() {
      let ud = this.ids[0]
      this.PopwindowDate = this.PopwindowDate.filter(item => item.id !== ud);
    ...
    handleSelectionTable(selection) {
      this.idsTable = selection.map(item => item.timeStamp);
    },
    handleQueryTable() {
      //查询
