            ...
            <el-row>
                <el-col :span="24" class="card-box">
                    <el-card>
                        ...
                        <el-row>
                            <el-col :span="12">
                                <el-form-item label="维修总时长:">
                                    <el-input
                                        disabled
                                        style="width: 90%"
                                        v-model="form.repairTotalTime"
                                    />
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
                                <el-form-item label="故障分析:" prop="model">
                                    <el-input
                                        style="width: 90%"
                                        placeholder="请输入故障分析"
                        ...
                        <el-row>
                            <el-col :span="12">
                                <el-form-item label="故障类型:" prop="fault_type">
                                    <el-select v-model="form.faultType" style="width: 90%;">
                                        <el-option
                                            v-for="item in  dict.type.fault_type"
                                            :key="item.value"
                                            :label="item.label"
                                            :value="item.value"
                                        />
                        ...
                        <el-row>
                            <el-col :span="12">
                                <el-form-item label="是否更换零部件:" prop="replaceAccessories">
