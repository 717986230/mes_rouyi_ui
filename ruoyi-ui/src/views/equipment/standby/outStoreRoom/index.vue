        ...
        <el-row :gutter="20">
            <el-col :span="24" :xs="24">
                <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="80px">
                    <el-form-item label="出库单号:" prop="ManufacturerId">
                    ...
                    <el-form-item label="出库类型:" prop="typeId">
                        <el-select v-model="queryParams.typeId" placeholder="请选择出库类型" clearable>
                            <el-option v-for="(dict,index) in dict.type.outstoreroom_type" :key="index" :label="dict.label"
                                       :value="dict.value" />
                        </el-select>
                    </el-form-item>
                    <el-form-item>
                ...
                <el-row :gutter="10" class="mb8">
                    ...
                    <el-col :span="1.5">
                        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handlePrint">打印出库单</el-button>
                    </el-col>
                ...
                <el-table v-loading="loading" :data="tableData" @selection-change="handleSelectionChange">
                    ...
                    <el-table-column fixed="left" label="出库单号" align="center" >
                    ...
                    <el-table-column label="出库日期" align="center"  key="InDate" prop="InDate"
                                     :show-overflow-tooltip="true" />
                    <el-table-column label="出库类型" align="center"  key="InType" prop="model" :show-overflow-tooltip="true">
                        <template slot-scope="scope">
                            <dict-tag :options="dict.type.outstoreroom_type" :value="scope.row.InType"/>
                        </template>
                    </el-table-column>
                    <el-table-column label="备件名称" align="center"  key="SpareName" prop="SpareName" :show-overflow-tooltip="true" />
                    <el-table-column label="出库仓库" align="center"  key="StorageLocation" prop="StorageLocation" />
                    <el-table-column label="出库总量" align="center"  key="TotalAmount" prop="TotalAmount" width="120" />
                    <el-table-column label="存放位置" align="center"  key="StorageLocationName" prop="StorageLocationName" width="120" />
                    <el-table-column label="出库操作人" align="center"  key="InPerson" prop="InPerson" width="120" />
...
export default {
    ...
    methods: {
        ...
        /** 新增按钮操作 */
        handleAdd() {
            this.$router.push("/equipment/standby/outStoreRoom/add");
        },
        /** 修改按钮操作 */
        handleUpdate(row) {
            this.$router.push({
                path: "/equipment/standby/outStoreRoom/edit",
                query: {
                    id: 1,
                },
            });
        ...
        handleDetail(idx,row){
            this.$router.push({
                path: '/equipment/standby/outStoreRoom/detail',
                query: {
                    id: 1
                }
            })
