                ...
                <el-col :span="24" class="card-box">
                    <el-card>
                        ...
                        <el-row>
                            <el-col :span="12">
                                <el-form-item label="入库类型" prop="InType">
                                    <el-select v-model="form.InType" placeholder="请选择入库类型" clearable  style="width: 90%" >
                            ...
                            <el-col :span="12">
                                <el-form-item label="入库单号:" prop="InNumber">
                                    <el-input
                                        disabled
                                        style="width: 90%"
                                        placeholder="系统自动生成"
                        ...
                        <el-row>
                            ...
                            <el-col :span="12">
                                <el-form-item label="入库操作人:" prop="InPerson">
                                    <el-input
                                        disabled
                                        style="width: 90%"
                                        placeholder="系统自动生成"
                        ...
                        <el-row>
                            <el-col :span="12">
                                <el-form-item label="关联单号:" prop="AssociatedDocument">
                                    <el-select v-model="form.AssociatedDocument"  placeholder="请选择入库类型" clearable  style="width: 90%">
                ...
                <el-col :span="24" class="card-box">
                    <el-card class="box-card">
                        <div slot="header" class="clearfix">
                            <span class="normal m20 bold">入库明细</span>
                        </div>
                        ...
                        <el-table :data="form.recodeList" @selection-change="handleSelectionChange">
                            ...
                            <el-table-column prop="inNum" label="入库数量"></el-table-column>
        ...
        <el-dialog :title="recordDialog.title" :visible.sync="recordDialog.open" width="600px" append-to-body>
            <el-form :model="recordDialog.form" :rules="recordDialog.rules" ref="recordDialogform" label-width="100px" size="small">
                ...
                <el-form-item label="入库数量" prop="inNum">
                    <el-input-number v-model="recordDialog.form.inNum" :min="1" placeholder="请输入库存数量" style="width: 90%"></el-input-number>
                </el-form-item>
    ...
    data() {
        return {
            ...
            rules: {
                ...
                InPerson: [
                    { required: true, message: "请选择入库操作人", trigger: "change" },
                ],
                AssociatedDocument: [
                    { required: false },
                ],
