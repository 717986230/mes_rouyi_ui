    ...
    <div class="jcc-con">
        <div class="jcc-left">
            <div class="jcc-top">
                <el-card class="box-card">
                    <div style="margin-bottom: 10px;">能源节点管网节点配置</div>
                    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch"
                        label-width="50">
                        <el-form-item label="工厂:" prop="mesFctrId">
                            <el-select size="mini" v-model="queryParams.mesFctrId" style="width: 140px;" placeholder="工厂"
                                clearable>
                        ...
                        <el-form-item label="介质:" prop="mediumId">
                            <el-select size="mini" v-model="queryParams.mediumId" style="width: 140px;" placeholder="介质"
                                clearable>
                                <el-option v-for="dict in UpperUnitList" :key="dict.value" :label="dict.label"
                                    :value="dict.value" />
                            </el-select>
                        </el-form-item>
                        <el-form-item label="管网:" prop="nodeName">
                            <el-select size="mini" v-model="queryParams.nodeName" style="width: 140px;" placeholder="管网"
                                clearable>
                                <el-option v-for="dict in UpperUnitList" :key="dict.value" :label="dict.label"
                                    :value="dict.value" />
                            </el-select>
                    ...
                    <div class="">
                        <el-table border v-loading="loading" :data="sideLineList" height="230"
                            ...
                            <el-table-column label="工厂" align="center" key="mesFctrName" prop="mesFctrName" />
                            <el-table-column label="管网名称" align="center" key="nodeName" prop="nodeName" />
                            <el-table-column label="介质名称" align="center" key="mtrlName" prop="mtrlName" />
                        </el-table>
        ...
        <el-card class="jcc-mon">
            <el-form :model="queryParamsDown" ref="queryFormLeft" size="small" :inline="true" v-show="showSearch"
                label-width="50">
                <el-form-item label="区域:" prop="nodeAreaType">
                    <el-select v-model="queryParamsDown.nodeAreaType" style="width: 140px;" placeholder="区域" clearable>
                        <el-option v-for="dict in OwningRegion" :key="dict.value" :label="dict.label" :value="dict.value" />
                    </el-select>
                </el-form-item>
                <el-form-item label="介质:" prop="mediumId">
                    <el-select v-model="queryParamsDown.mediumId" style="width: 140px;" placeholder="介质" clearable>
                        <el-option v-for="dict in SuperiorMaterial" :key="dict.value" :label="dict.label"
                            :value="dict.value" />
                    </el-select>
                </el-form-item>
                <el-form-item label="节点类型:" prop="type">
                    <el-select v-model="queryParamsDown.type" style="width: 140px;" placeholder="节点类型" clearable>
                        <el-option v-for="dict in nodeTypeList" :key="dict.value" :label="dict.label" :value="dict.value" />
                    </el-select>
                </el-form-item>
                <el-form-item label="节点名称:" prop="nodeName">
                    <el-input v-model="queryParamsDown.nodeName" style="width: 130px;" placeholder="节点名称" clearable
        ...
        <div class="jcc-right">
            <el-card class="jcc-ch-le">
                <el-table border height="250" v-loading="loadingDown" :data="AssignedList"
                    ...
                    <el-table-column label="节点名称" align="center" key="nodeName" prop="nodeName" />
                    <el-table-column label="区域名称" align="center" key="nodeAreaTypeName" prop="nodeAreaTypeName"
                        :show-overflow-tooltip="true" />
                    <el-table-column label="介质名称" align="center" key="mtrlName" prop="mtrlName"
                        :show-overflow-tooltip="true" />
                    <el-table-column label="节点类型" align="center" key="typeName" prop="typeName"
                        :show-overflow-tooltip="true" />
                    <el-table-column label="方向" align="center" key="directionName" prop="directionName"
                        :show-overflow-tooltip="true">
                    </el-table-column>
                </el-table>
            </el-card>
            ...
            <el-card class="jcc-ch-rg">
                <el-table border height="250" v-loading="loadingDown" :data="rightList"
                    ...
                    <el-table-column label="汇总节点" align="center" key="directionName1" prop="directionName1"
                        :show-overflow-tooltip="true">
                        <template slot-scope="scope">
                            <el-checkbox false-label="0" true-label="1" v-model="scope.row"></el-checkbox>
                        </template>
                    </el-table-column>
                    <el-table-column label="控制项" align="center" key="directionName2" prop="directionName2"
                        :show-overflow-tooltip="true">
                    </el-table-column>
                </el-table>
            </el-card>
...
<script>
export default {
    name: "EnergyNodeNetworkNodeConfiguration",
    data() {
        return {
            SuperiorMaterial: [],//介质
            OwningRegion: [],//所属区域
            ...
            queryParams: {
                mesFctrId: undefined,//工厂
                nodeName: "",//官网
                mediumId: undefined,//介质
                "basicId": undefined,
                "id": undefined,
                "isAsc": "",
                "nodeId": undefined,
    ...
    methods: {
        ...
        leftMod() {
            ...
            this.$api.e_pipeNetworkEnergyNodeSU(
                {
                    pipeNetworkId: this.currentSideLine.id,
                    energyNodeId: this.idsL[0],
                }
            ).then((res) => {
                if (res.code == 200) {
        ...
        rightMod() {
            //左 转 右
            this.$api.e_pipeNetworkEnergyNodeDel({ id: this.idsR[0] }).then((res) => {
                if (res.code == 200) {
                    this.handleTopItemSelected(this.currentSideLine)
        ...
        querySideLine(param) {
            this.$api.e_pipeNetworkList(param).then((res) => {
                if (res.code == 200) {
                    // 源节点列表
        ...
        handleTopItemSelected(item) {
            ...
            const promise1 = this.$api.e_energyNodeList(
                this.queryParamsDown
            )
            //右
            const promise2 = this.$api.e_pipeNetworkEnergyNodeList(
                this.queryParamsDown
            )
