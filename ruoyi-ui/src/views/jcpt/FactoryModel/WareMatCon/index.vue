            ...
            <div class="jcc-top">
                <el-card class="box-card">
                    ...
                    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch"
                        ...
                        <el-form-item label="仓库类型:" prop="stockTypeId">
                            <el-select v-model="queryParams.stockTypeId" style="width: 100%;" placeholder="请选择进仓库类型"
                                clearable>
                                <el-option v-for="dict in inoutTypeList" :key="dict.value" :label="dict.name"
                                    :value="dict.id" />
                            </el-select>
                        </el-form-item>
                        <el-form-item label="仓库:" prop="nodeAreaName">
                            <el-input v-model="queryParams.nodeAreaName" style="width: 100%;" placeholder="请输入仓库" clearable
        ...
        <div class="jcc-right">
            <el-card class="box-card">
                ...
                <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch"
                    ...
                    <el-form-item label="物料:" prop="mtrlNmae">
...
export default {
    ...
    methods: {
        ...
        deviceChange() {
            this.querySideLine({
                mesWspId: this.queryParams.mesFctrId,
                stockTypeId: this.queryParams.stockTypeId,
                nodeAreaName: this.queryParams.nodeAreaName,

            })
        },
        // 查询仓库
        querySideLine(param) {
            this.$api.i_stockallList(param).then((res) => {
                if (res.code == 200) {
        ...
        handleTopItemSelected(item) {
            ...
            //已分配
            const promise1 = this.$api.i_stockMtrlList({
                "nodeId": item.id
            })
            //未分配
