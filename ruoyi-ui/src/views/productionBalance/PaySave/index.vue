<template>
    ...
    <div class="app-container">
        ...
        <el-table :data="tableList">
            ...
            <el-table-column label="物料类别" prop="tankName" key="tankName" width="150"></el-table-column>
            <el-table-column label="物料名称" prop="tankArea" key="tankArea" width="150"></el-table-column>
            <el-table-column label="盈亏" prop="beginTime" key="beginTime"></el-table-column>
            <el-table-column label="期初库存" prop="endTime" key="endTime"></el-table-column>
            <el-table-column label="期末库存" prop="" key="unlockTime"></el-table-column>
            <el-table-column label="购入量" prop="tjNum" key="unlockUser" width="150"></el-table-column>
            <el-table-column label="出厂量" prop="tjNum" key="unlockUser" width="150"></el-table-column>
            <el-table-column label="产出量" prop="tjNum" key="unlockUser" width="150"></el-table-column>
            <el-table-column label="加工量" prop="tjNum" key="unlockUser" width="150"></el-table-column>
            <el-table-column label="转入量" prop="tjNum" key="unlockUser" width="150"></el-table-column>
            <el-table-column label="转出量" prop="tjNum" key="unlockUser"></el-table-column>
            <el-table-column label="付交库" prop="tjNum" key="unlockUser" width="150"></el-table-column>
            <el-table-column label="收交库" prop="tjNum" key="unlockUser"></el-table-column>
            <el-table-column label="收退库" prop="tjNum" key="unlockUser" width="150"></el-table-column>
            <el-table-column label="付退库" prop="tjNum" key="unlockUser"></el-table-column>
            <el-table-column label="互供入" prop="tjNum" key="unlockUser" width="150"></el-table-column>
            <el-table-column label="互供出" prop="tjNum" key="unlockUser"></el-table-column>
            <el-table-column label="损失" prop="tjNum" key="unlockUser" width="150"></el-table-column>
        </el-table>
