...
var width = dom.clientWidth === 0 || dom.clientWidth>100?100:dom.clientWidth //默认宽度
...
function setValue (value){
    ...
    drawBasic() //重新填入底色
    ctx.clearRect(0,0,100,getYByValue(value)) //清除这个值以上的区域
...
function TempBar(el){
    ...
    var width = dom.clientWidth === 0 || dom.clientWidth>100?50:dom.clientWidth
