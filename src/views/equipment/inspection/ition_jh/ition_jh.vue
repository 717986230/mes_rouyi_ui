<template>
  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" label-width="80px" @submit.native.prevent>
      <el-form-item label="计划时间:" prop="requisitionDate">
        <el-date-picker v-model="queryParams.requisitionDate" type="datetime" placeholder="计划时间" style="width: 100%"
          clearable>
        </el-date-picker>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleToDetail(id) {
      this.$router.push({
        path: "/equipment/inspection/ition_jh/detail",
        query: {
          id: id,
        },
      });
