<template>
  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" label-width="130px"
      ...
      <el-form-item label="维护计划开始时间:" prop="requisitionDate">
        <el-date-picker v-model="queryParams.requisitionDate" type="datetime" placeholder="巡检计划开始时间"
                        style="width: 100%"
                        clearable>
        </el-date-picker>
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="维护计划名称" align="center" key="name" prop="name" :show-overflow-tooltip="true">
      ...
      <el-table-column label="维护计划编号" align="center" key="num" prop="num" :show-overflow-tooltip="true"/>
      ...
      <el-table-column label="计划开始时间" align="center" key="Purchasetime" prop="Purchasetime"
                       :show-overflow-tooltip="true"/>
      <el-table-column label="计划结束时间" align="center" key="Plannedtime" prop="Plannedtime"
                       :show-overflow-tooltip="true"/>
      <el-table-column label="执行规则" align="center" key="Actualtime" prop="Actualtime"
                       :show-overflow-tooltip="true"/>
      <el-table-column label="计划提报人" align="center" key="department" prop="department"
                       :show-overflow-tooltip="true">
      </el-table-column>
      <el-table-column label="维护负责人" align="center" key="user" prop="user" :show-overflow-tooltip="true"/>
      ...
      <el-table-column label="维护规章" align="center">
        <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    handleAdd() {
      this.$router.push({
        path: "/equipment/Equipmentmaintenance/Maintenance_schedule/scheduleaddOrEdit",
        query: {
          id: "",
        },
      });
    ...
    handleToDetail(id) {
      this.$router.push({
        path: "/equipment/Equipmentmaintenance/Maintenance_schedule/scheduledetail",
        query: {
          id: id,
        },
      });
    ...
    /** 下载模板操作 */
    importTemplate() {
      this.download('energy/basicCalculateUnit/export', {}, `巡检任务_${new Date().getTime()}.xlsx`)
    },
    // 文件上传中处理
