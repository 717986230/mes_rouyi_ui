        ...
        <el-row :gutter="20">
            <el-col :span="24" :xs="24">
                <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="100px">
                    ...
                    <el-form-item label="审核状态" prop="numbers">
                        <el-select v-model="queryParams.areaID" placeholder="请选择审核状态" style="width: 90%">
                ...
                <el-table v-loading="loading" :data="tableData" @selection-change="handleSelectionChange">
                    ...
                    <el-table-column label="关联单号" align="center" sortable key="item4" prop="item4"/>
                    <el-table-column label="设备名称" align="center" sortable key="item5" prop="item5"/>
                    <el-table-column label="设备编号" align="center" sortable key="item6" prop="item6"/>
                    <el-table-column label="规格型号" align="center" sortable key="item7" prop="item7"/>
                    <el-table-column label="所属区域" align="center" sortable key="item8" prop="item8"/>
                    <el-table-column label="存放位置" align="center" sortable key="item9" prop="item9"/>
                    <el-table-column label="故障类型" align="center" sortable key="item10" prop="item10"/>
                    <el-table-column label="故障描述" align="center" sortable key="item11" prop="item11"/>
                    <el-table-column label="维修开始时间" align="center" sortable key="item12" prop="item12"/>
                    <el-table-column label="维修结束时间" align="center" sortable key="item13" prop="item13"/>
                    <el-table-column label="维修负责人" align="center" sortable key="item14" prop="item14"/>
                    <el-table-column label="现场图片" align="center" >
                        <template slot-scope="scope">
                            <i class="el-icon-picture large primary" @click="handlePicture(scope.row.item15)"></i>
                        </template>
                    </el-table-column>
                    <el-table-column label="备注" align="center" sortable key="item16" prop="item16"/>
                </el-table>
...
export default {
    ...
    methods: {
        ...
        getList() {
            this.loading = true;
            this.$api.MaintenanceTasksList(this.queryParams).then(response => {
        ...
        handleDetail(idx,row){
            this.$router.push({
                path: '/equipment/maintenance/task/detail',
                query: {
                    id: 1
                }
            })
