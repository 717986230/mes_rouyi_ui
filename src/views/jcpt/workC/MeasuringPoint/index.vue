    ...
    <div class="app-container">
        <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch">
            <el-form-item label="名称:" prop="instrName">
                <el-input v-model="queryParams.instrName" placeholder="名称" clearable size="small"
                    @keyup.enter.native="handleQuery" />
            </el-form-item>
            <el-form-item label="界区:" prop="nodeAreaName">
                <el-input v-model="queryParams.nodeAreaName" placeholder="界区" clearable size="small"
                    @keyup.enter.native="handleQuery" />
            </el-form-item>
            <el-form-item label="工位号:" prop="tag">
                <el-input v-model="queryParams.tag" placeholder="工位号" clearable size="small"
                    @keyup.enter.native="handleQuery" />
            </el-form-item>
        ...
        <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
            <el-form ref="form" :model="form" :rules="rules" label-width="90px">
                ...
                <el-row>
                    <el-col :span="10">
                        <el-form-item label="工位号:" prop="tag">
                            <el-input v-model="form.tag" placeholder="工位号" type="number" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="4" style="height: 10px;"></el-col>
                    <el-col :span="10">
...
export default {
    ...
    data() {
        return {
            ...
            upload: {
                ...
                // 上传的地址
                url: process.env.VUE_APP_BASE_API + "/mes/instrument/import"
    ...
    methods: {
        ...
        getList() {
            this.loading = true;
            this.$api.i_instrumentList(this.queryParams).then(response => {
        ...
        handleUpdate(row) {
            ...
            this.formType = 'edit'
            this.$api.i_instrumentBYid({ id: postId }).then(res => {
            ...
            this.$refs["form"].validate(valid => {
                if (valid) {
                    if (this.form.id != undefined) {
                        ...
                        this.$api.i_instrumentSU(this.form).then(response => {
        ...
        handleDelete(row) {
            const postId = row.id || this.ids[0]
            this.$modal.confirm('是否确认删除"' + row.mesFctrName + '"的数据项？').then(() => {
                return this.$api.i_instrumentDel({ id: postId })
            }).then(() => {
                this.getList();
        ...
        /** 导出按钮操作 */
        handleExport() {
            this.download('/mes/instrument/export', {
                ...this.queryParams
