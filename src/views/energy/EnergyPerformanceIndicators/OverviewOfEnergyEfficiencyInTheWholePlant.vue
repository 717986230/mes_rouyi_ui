            ...
            <el-col :span="24">
                <div class="cardbgimg">
                    <div class="card-title">
                        ...
                        color: #333333;
                        ">{{ cardTitile }} </span>
                        <span style="font-size: 24px;color: #666;">{{ dayjs(new Date()).format('YYYY-MM-DD HH:mm:ss')
                        }}</span>
                    </div>
                    <!-- <div :style="{
                    ...
                    <div class="child1" style="margin-top: 100px;">
                        <div v-for="item in cardList[0].child1"> {{ item }}
                        </div>
                    </div>
                    <div class="child">
                        <div v-for="item in cardList[0].child">{{ item }}</div>
                    </div>
                </div>
            </el-col>
        </el-row>
...
var self;
export default {
    name: "OverviewOfEnergyEfficiencyInTheWholePlant",
    components: { TbCard },
    data() {
        return {
